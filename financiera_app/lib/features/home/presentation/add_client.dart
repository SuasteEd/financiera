...
//     'fiel_serial_number': 'Número de serie FIEL',
//     'rfc': 'RFC',
//     'curp': 'CURP',
//     'street': 'Calle',
//     'colony': 'Colonia',
...
//     ...[
//       'name', 'phone', 'email', 'fiel_serial_number', 'rfc', 'curp',
//       'street', 'colony', 'state', 'municipality', 'nationality',
//       'postal_code', 'birthplace', 'birthdate', 'marital_status',
//       'gender', 'marital_regime', 'occupation', 'spouse_name',
//       'spouse_nationality', 'spouse_email', 'pep_position', 'pep_period',
//       'related_pep_name', 'related_pep_position', 'credit_destination',
//       'resource_origin', 'payment_frequency', 'payment_type', 'status',
//       'monthly_income', 'other_income', 'payment_count', 'payment_amount',
...
//       'aval_occupation',
//       'aval_spouse_name',
//       'aval_spouse_nationality',
//       'aval_spouse_email',
//     ],
//   ];

//   bool isPep = false;
//   bool relatedToPep = false;
//   bool actsOnOwnBehalf = true;
//   bool usesOwnResources = true;
...
//               ),
//               ...fields.map((f) => buildTextField(_getLabel(f), f)),

//               const SizedBox(height: 20),
//               SwitchListTile(
//                 title: const Text('¿Es PEP?'),
//                 value: isPep,
//                 onChanged: (val) => setState(() => isPep = val),
//               ),
//               SwitchListTile(
//                 title: const Text('¿Relacionado con PEP?'),
//                 value: relatedToPep,
//                 onChanged: (val) => setState(() => relatedToPep = val),
//               ),
//               SwitchListTile(
//                 title: const Text('¿Actúa por cuenta propia?'),
//                 value: actsOnOwnBehalf,
//                 onChanged: (val) => setState(() => actsOnOwnBehalf = val),
//               ),
//               SwitchListTile(
//                 title: const Text('¿Utiliza recursos propios?'),
//                 value: usesOwnResources,
//                 onChanged: (val) => setState(() => usesOwnResources = val),
//               ),
...
//                       ),
//                       isPep: isPep,
//                       relatedToPep: relatedToPep,
//                       actsOnOwnBehalf: actsOnOwnBehalf,
//                       usesOwnResources: usesOwnResources,
...
//                         spouseNationality:
//                             controllers['aval_spouse_nationality']?.text,
          ...
          child: ListView(
            children: [
              ...
              CheckboxListTile(
                title: const Text('¿Es PEP?'),
                value: isPep,
                onChanged: (val) => setState(() => isPep = val ?? false),
              ),
              if (isPep) ...[
                buildTextField(_getLabel('pep_position'), 'pep_position'),
                buildTextField(_getLabel('pep_period'), 'pep_period'),
              ],
              CheckboxListTile(
                title: const Text('¿Relacionado con PEP?'),
                value: relatedToPep,
                onChanged: (val) => setState(() => relatedToPep = val ?? false),
              ),
              if (relatedToPep) ...[
                buildTextField(
                  _getLabel('related_pep_name'),
                  'related_pep_name',
                ),
                buildTextField(
                  _getLabel('related_pep_position'),
              ...
              CheckboxListTile(
                ...
                value: actsOnOwnBehalf,
                onChanged:
                    (val) => setState(() => actsOnOwnBehalf = val ?? true),
              ),
              CheckboxListTile(
                title: const Text('¿Utiliza recursos propios?'),
                value: usesOwnResources,
                onChanged:
                    (val) => setState(() => usesOwnResources = val ?? true),
              ),
